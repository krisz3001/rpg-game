...
let lvl_description = [
    ["Egy beteges spanyol jobbágy vagy.", "profile_lvl0.jpg"],
    ["Egy gazdag spanyol földesúr vagy.","profile_lvl1.jpg"],
    ["Egy gazdag spanyol tudós vagy.","profile_lvl2.jpg"],
    ["Te vagy a spanyol király.", "profile_lvl3.jpg"]
];
...
function kaszalas(){
    ...
    if(szazalek >= sebzes_eselye){
        ...
        // stats.life -= 1;
        fight("A Spanyol inkvizíció", 5, 100);
        refreshProfileStats();
    }else{
...
function fight(e_name, e_damage, e_life){
    story.innerHTML += "Senki nem számított rá, de munka közben megtámadott téged " + e_name + "!<br>";
	story.innerHTML += "<img src='pics/si.jpg' style='width: 50%'><br>"
    ...
    do {
        ...
        if(enemy_attack){
            ...
            if(szazalek >= sebzes_eselye){
                ...
                story.innerHTML += e_name + "-nak maradt " + e_life;
                refreshProfileStats();
            }else{
